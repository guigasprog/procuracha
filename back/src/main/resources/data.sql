...
INSERT INTO contrato (id, data, hora, problema, cliente_id, profissional_id) VALUES
                                                                                 ...
                                                                                 (4, '2024-08-25', '11:00:00', 'Pintura de parede', 4, 1),  -- Ana Costa contratando Pedro Lima
                                                                                 (5, '2024-08-26', '13:00:00', 'Manutenção de jardim', 5, 1),  -- Maria Oliveira contratando Carlos Souza
                                                                                 (6, '2024-08-24', '09:00:00', 'Conserto de encanamento', 3, 4),  -- Maria Oliveira contratando Carlos Souza
                                                                                 (7, '2024-08-24', '09:00:00', 'Conserto de encanamento', 3, 4),  -- Maria Oliveira contratando Carlos Souza
                                                                                 (8, '2024-08-24', '09:00:00', 'Conserto de encanamento', 3, 4);  -- Pedro Lima contratando João Silva
...
INSERT INTO feedback (id, aceito, resolvido, nota, descricao, contrato_id) VALUES
                                                                               ...
                                                                               (4, false, false, 0, '', 4),
                                                                               (5, true, true, 8, 'Jardim ficou bom, mas o profissional não levou todas as ferramentas necessárias.', 5),
                                                                               (6, true, true, 9, 'Conserto de encanamento perfeito, sem vazamentos.', 6),
                                                                               (7, true, true, 9, 'Conserto de encanamento perfeito, sem vazamentos.', 7),
                                                                               (8, true, true, 9, 'Conserto de encanamento perfeito, sem vazamentos.', 8);